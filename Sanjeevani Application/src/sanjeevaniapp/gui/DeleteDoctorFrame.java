...
public class DeleteDoctorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcDocIds.setBackground(new java.awt.Color(153, 204, 255));
        jcDocIds.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jcDocIds.setForeground(new java.awt.Color(0, 0, 0));
        jcDocIds.setOpaque(false);
        ...
        btnDeleteDoc.setBackground(new java.awt.Color(0, 0, 0));
        btnDeleteDoc.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        btnDeleteDoc.setForeground(new java.awt.Color(255, 255, 255));
        btnDeleteDoc.setText("Delete");
        btnDeleteDoc.setEnabled(false);
        btnDeleteDoc.setOpaque(false);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addComponent(btnDeleteDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            .addGap(130, 130, 130)
                            .addComponent(jLabel2)
                            .addGap(42, 42, 42)
                            .addComponent(jcDocIds, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
                            .addComponent(jcDocIds, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnDeleteDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteDocActionPerformed
        try{
            String docId = jcDocIds.getSelectedItem().toString();
            boolean result = DoctorDao.deleteDocbyId(docId);
            if(result){
                JOptionPane.showMessageDialog(null,"Record Deleted Successfully");
                jcDocIds.removeItem(docId);
                if(jcDocIds.getItemCount() == 0){
