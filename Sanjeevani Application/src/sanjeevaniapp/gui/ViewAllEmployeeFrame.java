...
public class ViewAllEmployeeFrame extends javax.swing.JFrame {
    ...
    public ViewAllEmployeeFrame() {
        ...
        model = (DefaultTableModel)jtEmpsDetails.getModel();
    ...
    private void initComponents() {
        ...
        jtEmpsDetails = new javax.swing.JTable();
        ...
        jtEmpsDetails.setBackground(new java.awt.Color(153, 204, 255));
        jtEmpsDetails.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jtEmpsDetails.setForeground(new java.awt.Color(0, 0, 0));
        jtEmpsDetails.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Employee ID", "Employee Name", "Role", "Employee Salary"
            }
        ) {
        ...
        jtEmpsDetails.setGridColor(new java.awt.Color(0, 0, 0));
        jtEmpsDetails.setOpaque(false);
        jtEmpsDetails.setSelectionBackground(new java.awt.Color(255, 255, 255));
        jtEmpsDetails.setSelectionForeground(new java.awt.Color(0, 0, 0));
        jScrollPane1.setViewportView(jtEmpsDetails);
    ...
    private javax.swing.JTable jtEmpsDetails;
    // End of variables declaration//GEN-END:variables

    private void loadEmployeesDetails(){
        try{
            List<EmpPojo> empList = EmpDao.getAllEmpDetails();
            if(empList.isEmpty()){
