...
public class ViewAllPatientsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("All Patients Details");
        ...
        jtPatsDetails.setBackground(new java.awt.Color(153, 204, 255));
        jtPatsDetails.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jtPatsDetails.setForeground(new java.awt.Color(0, 0, 0));
        jtPatsDetails.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "P_ID", "F_NAME", "S_NAME", "AGE", "OPD", "GENDER", "M_STATUS", "P_DATA", "ADDRESS", "CITY", "PHONE_NO", "DOCTOR_ID"
            }
        ) {
        ...
        jtPatsDetails.setGridColor(new java.awt.Color(0, 0, 0));
        jtPatsDetails.setOpaque(false);
        jtPatsDetails.setSelectionBackground(new java.awt.Color(255, 255, 255));
        jtPatsDetails.setSelectionForeground(new java.awt.Color(0, 0, 0));
